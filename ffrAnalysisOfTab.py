...
fs, data = wavfile.read('Sound/upByAnkur1.wav')
if i== '1':
    fs, data = wavfile.read('Sound/tabByAnkur1.wav')
elif i== '2':
    fs, data = wavfile.read('Sound/tabByAnkur2.wav')
elif i== '3':
    fs, data = wavfile.read('Sound/tabByAnkur3.wav')
elif i== '4':
    fs, data = wavfile.read('Sound/tabByAnkur4.wav')
