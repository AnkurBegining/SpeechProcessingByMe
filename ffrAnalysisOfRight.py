...
fs, data = wavfile.read('Sound/rightByAnkur1.wav')
if i== '1':
    fs, data = wavfile.read('Sound/rightByAnkur1.wav')
elif i== '2':
    fs, data = wavfile.read('Sound/rightByAnkur2.wav')
elif i== '3':
    fs, data = wavfile.read('Sound/rightByAnkur3.wav')
elif i== '4':
    fs, data = wavfile.read('Sound/rightByAnkur4.wav')
