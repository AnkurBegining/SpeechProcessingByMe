...
fs, data = wavfile.read('Sound/downByAnkur1.wav')
if i== '1':
    fs, data = wavfile.read('Sound/downByAnkur1.wav')
elif i== '2':
    fs, data = wavfile.read('Sound/downByAnkur2.wav')
elif i== '3':
    fs, data = wavfile.read('Sound/downByAnkur3.wav')
elif i== '4':
    fs, data = wavfile.read('Sound/downByAnkur4.wav')
